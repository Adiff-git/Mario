...
#include "../inc/ScoreEffect.h"  // Include để set current player
...
GameWorld::GameWorld(int MapID, GameScreen *gameScreen, bool multiplayer,
                     CharacterType p1Type, CharacterType p2Type) : player1(nullptr), player2(nullptr),
                                                                   ...
                                                                   player2Character(p2Type)
{
    ...
    if (MapID == 1)
    {
        ...
        map.GetEnemies().push_back(new PiranhaPlant(Vector2{1200, 800}));
