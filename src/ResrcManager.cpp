...
void ResrcManager::loadTextures() {
    ...
    textures["Moving 1"]=LoadTexture("resources/images/gui/Moving_1.png");
        textures["Moving 2"]=LoadTexture("resources/images/gui/Moving_2.png");
        textures["Moving 3"]=LoadTexture("resources/images/gui/Moving_3.png");
        textures["Moving 4"]=LoadTexture("resources/images/gui/Moving_4.png");
